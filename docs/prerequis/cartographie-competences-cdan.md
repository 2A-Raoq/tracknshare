...
| 5 | Envisager toutes les possibilités pour livrer un logiciel déverminé (recherche systématique d'erreur) | ✅ | **Renforcé (2026-06-28)** : 36 tests back (Jest) + 19 tests front (Vitest) verts, exécutés en **CI GitHub Actions** (lint + build + tests bloquants) = outils de contrôle automatique du code. Reste les tests e2e pour aller plus loin. Voir [ecart-doc-code-et-rncp.md](ecart-doc-code-et-rncp.md) |
...
| 7 | Préparer des jeux d'essai (logiciel déverminé, sans anomalie) | ✅ | **Renforcé (2026-06-28)** : 36 tests back (score, guards, auth, users, validation config) + 19 tests front (Vitest) verts, exécutés en CI via `test:ci`. Reste les tests e2e pour aller plus loin. Voir [ecart-doc-code-et-rncp.md](ecart-doc-code-et-rncp.md) |
