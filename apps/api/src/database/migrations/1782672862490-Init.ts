...
export class Init1782672862490 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "chat_messages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "teamId" uuid NOT NULL, "senderId" uuid NOT NULL, "content" text, "encryptedContent" text, "iv" character varying(64), "authTag" character varying(64), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_40c55ee0e571e268b0d3cd37d10" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "idx_leaderboard_query" ON "player_stats" ("gameId", "seasonId", "score") `);
        ...
        await queryRunner.query(`CREATE TABLE "conversations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying NOT NULL DEFAULT 'DIRECT', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ee34f4f7ced4ec8681f26bf04ef" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_achievements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "achievementId" uuid NOT NULL, "unlockedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_c1acd69cf91b1e353634c152dd7" UNIQUE ("userId", "achievementId"), CONSTRAINT "PK_3d94aba7e9ed55365f68b5e77fa" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "chat_messages" ADD CONSTRAINT "FK_3a35ec020082bf1171cbb88d09a" FOREIGN KEY ("teamId") REFERENCES "teams"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "player_stats" ADD CONSTRAINT "FK_a14e90bda5a40cf0b150c6dc87f" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "player_stats" ADD CONSTRAINT "FK_dda32e4af0ba81ca82ac5379578" FOREIGN KEY ("gameId") REFERENCES "games"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "player_stats" ADD CONSTRAINT "FK_e8ecfb1db35dff1acfac9533922" FOREIGN KEY ("seasonId") REFERENCES "seasons"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "private_messages" ADD CONSTRAINT "FK_6c99f5465cc85de2563ebc6ed28" FOREIGN KEY ("conversationId") REFERENCES "conversations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "private_messages" ADD CONSTRAINT "FK_5938be33949ac6364947acbc832" FOREIGN KEY ("senderId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "friend_requests" ADD CONSTRAINT "FK_da724334b35796722ad87d31884" FOREIGN KEY ("senderId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "private_messages" DROP CONSTRAINT "FK_6c99f5465cc85de2563ebc6ed28"`);
        ...
        await queryRunner.query(`ALTER TABLE "player_stats" DROP CONSTRAINT "FK_e8ecfb1db35dff1acfac9533922"`);
        await queryRunner.query(`ALTER TABLE "player_stats" DROP CONSTRAINT "FK_dda32e4af0ba81ca82ac5379578"`);
        await queryRunner.query(`ALTER TABLE "player_stats" DROP CONSTRAINT "FK_a14e90bda5a40cf0b150c6dc87f"`);
        await queryRunner.query(`ALTER TABLE "chat_messages" DROP CONSTRAINT "FK_fc6b58e41e9a871dacbe9077def"`);
        await queryRunner.query(`ALTER TABLE "chat_messages" DROP CONSTRAINT "FK_3a35ec020082bf1171cbb88d09a"`);
